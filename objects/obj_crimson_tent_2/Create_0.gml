...
layer_sprite_create(_layer[0], x, y, spr_crimson_tent_2_front);
...
mask_index = spr_crimson_tent_2_collision;

var coll = instance_create_depth(x,y,depth-1,obj_collision)
coll.sprite_index = spr_crimson_tent_2_collision
coll.mask_index = spr_crimson_tent_2_collision
coll.LPoint = bbox_left+10
coll.RPoint = bbox_right-10

coll.yvalue = bbox_top+40-10
coll.yvalue2 = bbox_bottom-(20-10)

coll.grabableTop = coll.yvalue+10
coll.grabableBot = coll.yvalue2+10