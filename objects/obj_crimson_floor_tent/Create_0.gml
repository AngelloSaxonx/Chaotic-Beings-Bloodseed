...
grabableTop = bbox_top + 40
grabableBot = bbox_bottom - 40

var _layer = layer_get_id_at_depth(-999)[0];
if(_layer == -1) _layer[0] = layer_create(-900);
if(_layer != -1) _layer[1] = layer_create(300);

layer_sprite_create(_layer[0], x, y, spr_crimson_floor_tent_front);
layer_sprite_create(_layer[1], x, y, spr_crimson_floor_tent_back);
...
mask_index = spr_crimson_floor_tent_collision